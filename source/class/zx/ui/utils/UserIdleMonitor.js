...
qx.Class.define("zx.ui.utils.UserIdleMonitor", {
  ...
  construct: function (duration, callback, context) {
    this.base(arguments, duration, callback, context);

    this.__onUserEventHandler = qx.lang.Function.bind(this.__onUserEvent, this);
    for (
      var i = 0, NAMES = zx.ui.utils.UserIdleMonitor.__NAMES;
      i < NAMES.length;
      i++
    )
  ...
  statics: {
    ...
    getInstance: function () {
      if (!this.__instance) this.__instance = new zx.ui.utils.UserIdleMonitor();
