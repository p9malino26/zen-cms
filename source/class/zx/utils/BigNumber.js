 ...
 *
 *  Copyright:
 *    2019-2023 Zenesis Ltd, https://www.zenesis.com
 *
 *  License:
...
/**
 * Just use `@use` in your class to import this class.
 * @ignore(crypto)
 * @ignore(define)
 * @ignore(module)
 * @ignore(self)
      ...
      if (x.c) {
        ...
        str = fractionPart
          ? intPart +
            ...
            ((g2 = +format.fractionGroupSize) ? fractionPart.replace(new RegExp("\\d{" + g2 + "}\\B", "g"), "$&" + (format.fractionGroupSeparator || "")) : fractionPart)
          : intPart;
      }
