...
qx.Class.define("zx.cms.content.ContainerPieceMiniEditor", {
  ...
  members: {
    ...
    _createQxObjectImpl(id) {
      switch (id) {
        case "root":
          var comp = super._createQxObjectImpl(id);
        ...
        case "cboOrientation":
          ...
          cbo.add(new qx.ui.form.ListItem("Horizontal", "@FontAwesomeSolid/grip-horizontal/16", "horizontal"));

          cbo.add(new qx.ui.form.ListItem("Vertical", "@FontAwesomeSolid/grip-vertical/16", "vertical"));

          cbo.add(new qx.ui.form.ListItem("Flow", "@FontAwesomeSolid/stream/16", "flow"));
