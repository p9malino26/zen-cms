      ...
      switch (id) {
        case "btnAlert":
          ...
          btn.addListener("execute", async () => {
            await zx.thin.ui.utils.Alert.show("This is an alert!", "Alert Caption");
        ...
        case "btnConfirm":
          ...
          btn.addListener("execute", async () => {
            let result = await zx.thin.ui.utils.Confirm.show("This is a choice", "Choice Caption");
        ...
        case "btnWorking":
          ...
          btn.addListener("execute", () => {
            ...
            let fns = [
              ...
              () => dlg.addTask("Lorem ipsum dolor sit amet, consectetur adipiscing"),
