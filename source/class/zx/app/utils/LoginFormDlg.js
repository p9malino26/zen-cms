...
qx.Class.define("zx.app.utils.LoginFormDlg", {
  ...
  members: {
    ...
    _createQxObjectImpl(id) {
      switch (id) {
        case "btnSubmit":
          var btn = new qx.ui.form.Button("Login", "@FontAwesomeSolid/sign-in-alt/16");
    ...
    async submitDialog() {
      ...
      if (!username || !password) {
        zx.ui.utils.MessageDlg.showError("Please provide a username and password to login");
      ...
      if (!result || result.status != "ok") {
        zx.ui.utils.MessageDlg.showError("Incorrect username or password, please try again");
