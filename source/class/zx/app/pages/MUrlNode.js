  ...
  members: {
    ...
    setPath(value) {
      if (value !== this.getPath())
        throw new Error(
          `Unexpected attempt to change the path of a ${
            this.classname
          } through '.setPath', from ${this.getPath()} to ${value}`
        );
    },
    ...
    resetPath() {
      throw new Error(
        `Unexpected attempt to reset the path of a ${
          this.classname
        } through '.resetPath', from ${this.getPath()}`
      );
    },
    ...
    setParentPath(value) {
      if (value !== this.getPath())
        throw new Error(
          `Unexpected attempt to change the parentPath of a ${
            this.classname
          } through '.setParentPath', from ${this.getParentPath()} to ${value}`
        );
    },
    ...
    resetParentPath() {
      throw new Error(
        `Unexpected attempt to reset the parentPath of a ${
          this.classname
        } through '.resetParentPath', from ${this.getParentPath()}`
      );
    }
  }
});
